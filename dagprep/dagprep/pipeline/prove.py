...
from dagprep.pipeline.data import Data
...
if __name__ == '__main__':
    ...
    worker_data = Data("Workers dataframe", worker_df)

    fullname_tf = Transformation("fullname", fullname)
    minmax_tf = Transformation("minmax", minmax)
    ...
    companies_data = Data("Companies dataframe", companies_df)

    upper_col_tf = Transformation("upper_col", upper_col)
    companies_data.chain(upper_col_tf, param_key="companies_df")

    add_companies_info_tf = Transformation("add_companies_info", add_companies_info)
    ...
    select_cols_tf = Transformation("select_cols", select_cols)
